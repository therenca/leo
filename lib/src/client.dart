...
class Client {
  ...
  Future<dynamic> getResponse(
      ...
      Map<String, String>? multipartInfo,
      ...
      case Method.POST:
        {
          if (multipartInfo != null || files != null) {
            ...
            request.fields.addAll(
                multipartInfo != null ? multipartInfo : <String, String>{});
            if (query != null) {
              Map<String, String> _query =
    ...
    Future<dynamic> _parseResponse(dynamic _res) async {
      if (_res != null) {
        ...
        if (verbose) {
          await pretifyOutput(
              '[$_now][SERVER RESPONSE][${_res.statusCode}] $bodyStr');
        }
          ...
          try {
            ...
            while (true) {
              ...
              if (_statusCode == 206) {
                ...
                if (verbose)
                  pretifyOutput(
                      '[$_uri][progress] $startByte / $contentLength}');
            ...
            if (verbose)
              pretifyOutput('[error][progress] ${e.toString()}',
                  color: Color.red);
            binary = null;
            controller?.close();
          }
